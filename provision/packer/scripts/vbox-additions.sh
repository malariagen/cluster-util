...
test -d /opt/VBoxGuestAdditions-${VBOX_VERSION}/lib/VBoxGuestAdditions && ln -s /opt/VBoxGuestAdditions-${VBOX_VERSION}/lib/VBoxGuestAdditions /usr/lib/VBoxGuestAdditions
