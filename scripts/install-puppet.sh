...
cat ../provision/puppet/code/environments/production/hieradata/common.yaml >> /etc/puppetlabs/code/environments/production/hieradata/common.yaml
cd ../provision/puppet/
./install-modules.sh 
cp -pr modules/* /etc/puppetlabs/code/modules/
vi /etc/puppetlabs/code/environments/production/hieradata/common.yaml
puppet apply -e "notice(lookup('sssd::config'))" 
